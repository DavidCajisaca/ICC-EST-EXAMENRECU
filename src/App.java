...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        persona = controller.buscarPorEdad(personas, 60);
        if (persona != null) {
        ...
        // Buscar por nombre
        persona = controller.buscarPorNombre(personas, "Sofia");
        if (persona != null) {
            System.out.println("Encontrada persona con nombre 'Sofia': " + persona.getNombre());
        } else {
            System.out.println("Persona con nombre 'Sofia' no encontrada.");
        }
